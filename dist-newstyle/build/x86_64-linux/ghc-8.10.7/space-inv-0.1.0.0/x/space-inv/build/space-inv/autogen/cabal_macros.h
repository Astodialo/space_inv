...
/* package space-inv-0.1.0.0 */
#ifndef VERSION_space_inv
#define VERSION_space_inv "0.1.0.0"
#endif /* VERSION_space_inv */
#ifndef MIN_VERSION_space_inv
#define MIN_VERSION_space_inv(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "space-inv-0.1.0.0-inplace-space-inv"
